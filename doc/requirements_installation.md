...
1) Clone this repository then go to its folder: `cd <YourEmulatorProjectPath` - make sure you are inside the MicrovoltsEmulator folder (root of this repository)
2) Clone vcpkg inside ExternalLibraries: `git clone https://github.com/microsoft/vcpkg.git ExternalLibraries/vcpkg && ./ExternalLibraries/vcpkg/bootstrap-vcpkg.sh`
